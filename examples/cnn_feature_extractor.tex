...
\node[text width=8cm, align=center] at (8.5,-6,0) {\tiny (16, 48)};
...
\node[text width=8cm, align=center] at (17,-6,0) {\tiny (32, 23)};
...
\node[text width=6cm, align=center, yshift=0.5cm, xshift=0cm] at (fc_quantum-north) {\tiny 1,474 params};
...
\pic[shift={(0.6,0,0)}] at (fc_sel1-east) 
    {Box={
        name=relu_sel,
        caption=ReLU,
        xlabel={{1, }},
...
\node[text width=8cm, align=center] at (15,-10.5,0) {\textbf{Total Parameters: 50,757}};
