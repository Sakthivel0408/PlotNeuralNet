...
\node[text width=8cm, align=center] at (-2,0,0) {\tiny Ch0: Base\\Ch1: Pu/Py\\Ch2: H-Bond};
...
\node[text width=8cm, align=center] at (2,5,0) {\tiny 256 params};

\pic[shift={(0.3,0,0)}] at (conv1-east) 
    {Box={
        name=bn1,
        caption=BN,
        xlabel={{16}},
...
\pic[shift={ (0.5,0,0) }] at (relu1-east) 
    {Box={
        name=pool1,
        caption=MaxPool\\k=2,
        fill=\PoolColor,
...
\pic[shift={(0.3,0,0)}] at (pool1-east) 
    {Box={
        name=drop1,
        caption=Drop\\0.3,
        xlabel={{16}},
...
\node[text width=8cm, align=center] at (7.5,-4,0) {\tiny (16, 48)};

\pic[shift={(2,0,0)}] at (drop1-east) 
    {Box={
        name=conv2,
        caption=Conv1D\\k=3,
        xlabel={{32, }},
...
\node[text width=8cm, align=center] at (10,5,0) {\tiny 1,568 params};

\pic[shift={(0.3,0,0)}] at (conv2-east) 
    {Box={
        name=bn2,
        caption=BN,
        xlabel={{32}},
...
\pic[shift={ (0.5,0,0) }] at (relu2-east) 
    {Box={
        name=pool2,
        caption=MaxPool\\k=2,
        fill=\PoolColor,
...
\pic[shift={(0.3,0,0)}] at (pool2-east) 
    {Box={
        name=drop2,
        caption=Drop\\0.3,
        xlabel={{32}},
...
\node[text width=8cm, align=center] at (15.5,-4,0) {\tiny (32, 23)};

\pic[shift={(2,0,0)}] at (drop2-east) 
    {Box={
        name=flatten,
        caption=Flatten\\736,
        xlabel={{736}},
...
\pic[shift={(3,3,0)}] at (flatten-east) 
    {Box={
        name=fc_quantum,
        caption=FC\\736→2,
        xlabel={{2}},
...
\pic[shift={(1.5,0,0)}] at (fc_quantum-east) 
    {Box={
        name=quantum_out,
...
\node[text width=8cm, align=center] at (24,4,0) {\tiny Range: [-π, π]\\Parameters for\\quantum circuit};

\node[text width=8cm, align=center] at (20.5,6,0) {\tiny 1,474 params};
...
\node[text width=8cm, align=center] at (20.5,-6,0) {\tiny 47,168 params};

\pic[shift={(0.5,0,0)}] at (fc_sel1-east) 
    {Box={
        name=relu_sel,
        caption=ReLU,
        xlabel={{1, }},
...
\pic[shift={(0.3,0,0)}] at (relu_sel-east) 
    {Box={
        name=drop_sel,
        caption=Drop\\0.2,
        xlabel={{1}},
...
\pic[shift={(1,0,0)}] at (drop_sel-east) 
    {Box={
        name=fc_sel2,
        caption=FC\\64→3,
        xlabel={{3}},
...
\node[text width=8cm, align=center] at (22.5,-2.5,0) {\tiny 195 params};

\pic[shift={(1.5,0,0)}] at (fc_sel2-east) 
    {Box={
        name=selector_out,
...
\node[text width=8cm, align=center] at (26,-3,0) {\tiny Probabilities for:\\Z, ZZ, Pauli\\feature maps};

\node[text width=8cm, align=center] at (12,-7,0) {\textbf{Total Parameters: 50,757}};

\node[text width=8cm, align=center] at (12,-8,0) {\tiny Receptive Field: 28 bases};
