    ...
    \node[text width=8cm, align=center] at (-4.5,1.5,0) {\small \textbf{Input Channels:}};

    \node[text width=8cm, align=center] at (-4.5,0.5,0) {\small Ch0: Base};

    \node[text width=8cm, align=center] at (-4.5,-0.5,0) {\small Ch1: Pu/Py};

    \node[text width=8cm, align=center] at (-4.5,-1.5,0) {\small Ch2: H-Bond};
