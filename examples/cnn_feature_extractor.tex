...
\pic[shift={ (1.0,0,0) }] at (relu1-east) 
    {Box={
        name=pool1,
        caption=MaxPool\\k=2,
        fill=\PoolColor,
...
\pic[shift={(0.8,0,0)}] at (pool1-east) 
    {Box={
        name=drop1,
        caption=Drop\\0.3,
        xlabel={{16}},
...
\pic[shift={ (1.0,0,0) }] at (relu2-east) 
    {Box={
        name=pool2,
        caption=MaxPool\\k=2,
        fill=\PoolColor,
...
\pic[shift={(0.8,0,0)}] at (pool2-east) 
    {Box={
        name=drop2,
        caption=Drop\\0.3,
        xlabel={{32}},
